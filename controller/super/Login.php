      ...
      if($user_data = $login_model->authenticate(new User($user_name, $password))){
          ...
          if($is_password_correct){
            ...
            function(){
               ...
               $.jnoty('An error happened while logging in', {
            sticky: false,
            header: 'Erro',
            theme: 'jnoty-danger',
            close: function() {window.location.replace('/')},
                  ...
                  header('location:/view/resetpassword/ChangePassword.php?name='.$user_name.'&data='.$isset.'') ;
            ...
            function(){
               ...
               $.jnoty('Wrong Username or Password', {
            sticky: false,
            header: 'Erro',
            theme: 'jnoty-danger',
            close: function() {window.location.replace('/')},
