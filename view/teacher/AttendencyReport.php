...
if(isset($_GET['grade'])) {
    ...
    $class_master_id = $_GET['grade'];

    $stm = SuperModel:: get_all_students_attendance_report_by_class($class_master_id);
    $row2 = SuperModel:: get_class_details_report($class_master_id);
        ...
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card-header table-card-header">
                    <br><br><br><h5>Attendance for grade <?php echo $row2['ClassCode'];?></h5>
                </div>
