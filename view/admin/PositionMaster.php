...
$(document).ready(function(){
   ...
   // check_max_terms();
    ...
    $(".add-new").click(function(){
        ...
        var row = '<tr>' +
            '<td><input type="text" class="form-control" name="position_arry[]" id="name"></td>' +
           '<td><input type="text" class="form-control" name="positondescription_arry[]" id="name"></td> '+
			'<td>' + actions + '</td>' +
	...
	$(document).on("click", ".add", function(){
		...
		if(!empty){
			...
			input.each(function(){
                           if (i==0){
                        $(this).parent("td").html($(this).val()+"<br><input type='hidden' name='position_arry[]' value='"+$(this).val()+"'/>");
                                                    i++;
                           }
                           
                           if (i==1){
                    $(this).parent("td").html($(this).val()+"<br><input type='hidden' name='positondescription_arry[]' value='"+$(this).val()+"'/>");
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['PositionName']; ?> <input type="hidden" name="position_arry[]" value="<?php echo $row['PositionName']; ?>"/> <input class="term_id" name="postion_master_id[]" value="<?php echo $row['TeacherPositionMasterID']; ?>" type="hidden"/></td>
...
<!--                            <a class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>-->
    ...
    <input type="hidden" value="postiotion_master_arry" name="btn_postiotion_master"/>
     <div id="txt_deleted_items"></div>
             ...
             <div class="hint-text">Showing <b><?php echo $limit;?></b> out of <b><?php echo $total_pages ?></b> entries</div>
                ...
                <ul class="pagination">
                    <li class="page-item "><a href="/TTMS/view/headteacher/PositionMaster.php?page= <?php echo $privious ?>">Previous</a></li>
                    <?php for ($i= 1; $i<=$pages; $i++) { ?>
                    
<!--                    <li class="page-item active"><a href="#" class="page-link">1</a></li>-->
                    <li class="page-item"><a href="/TTMS/view/headteacher/PositionMaster.php?page= <?php echo $i ?>" class="page-link"><?php echo $i ?></a></li>
                    <?php 
                   ...
                   $last  =$pages;
                    ...
                    ?>
                    <li class="page-item"><a href="/TTMS/view/headteacher/PositionMaster.php?page= <?php echo $next ?>" class="page-link">Next</a></li>
                </ul>
            </div>
        </div>
      </div>    
...
$(document).ready(
        function (){
          ...
          $('#btn_edit').click(function(){
            ...
            window.location.href = "/TTMS/view/headteacher/EditPositionMaster.php";
        });
