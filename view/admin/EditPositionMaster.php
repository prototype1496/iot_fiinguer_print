...
$start  =  ($page - 1) * $limit;
$stm = HeadTeacherModel::get_all_positions($start,$limit);
...
<script type="text/javascript">
       function check_max_terms (){
         //this function has been modified form the Term master.php and is not doing as the name sujests check_max_terms
         //all it is doing is decabling the app button on the grid 
	...
	$(document).on("click", ".add", function(){
		...
		if(!empty){
			...
			input.each(function(){
                                      ...
                                      if (i == 0)
                                            {
                                $(this).parent("td").html($(this).val()+"<input type='hidden' name='position_arry[]' value='"+$(this).val()+"'/><input type='hidden' name='isedited_arry[]' value='1'/>");

                                            i++;    
                                            }
                    $(this).parent("td").html($(this).val()+"<input type='hidden' name='positondescription_arry[]' value='"+$(this).val()+"'/>");
...
<body>
   ...
   <div class="card card-cascade narrower" style="margin-left: 2%; margin-right: 2%; margin-top: 1%;">
    ...
    <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
        ...
        <a href="" class="white-text mx-3">Position Master</a>
...
<form id="terms" method="post" action="../../controller/head_teacher/ActionPerformed.php">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <input class="term_id" name="postion_master_id[]" value="<?php echo $row['TeacherPositionMasterID']; ?>" type="hidden"/>
                        <td><?php echo $row['PositionName']; ?> <input type="hidden" name="position_arry[]" value="<?php echo $row['PositionName']; ?>"/> <input type='hidden' name='isedited_arry[]' value='0'/></td>
                       <td><?php echo $row['PositionDescription']; ?> <input type="hidden" name="positondescription_arry[]" value="<?php echo $row['PositionDescription']; ?>"/></td>
    ...
    <input type="hidden" value="btn_position_master_edit" name="btn_position_master_edit"/>
             ...
             <div class="hint-text">Showing <b><?php echo $limit;?></b> out of <b><?php echo $total_pages ?></b> entries</div>
                ...
                <ul class="pagination">
                    <li class="page-item "><a href="/TTMS/view/headteacher/EditTermMater.php?page= <?php echo $privious ?>">Previous</a></li>
                    <?php for ($i= 1; $i<=$pages; $i++) { ?>
                    
<!--                    <li class="page-item active"><a href="#" class="page-link">1</a></li>-->
                    <li class="page-item"><a href="/TTMS/view/headteacher/EditTermMater.php?page= <?php echo $i ?>" class="page-link"><?php echo $i ?></a></li>
                    <?php 
                   ...
                   $last  =$pages;
                    ...
                    ?>
                    <li class="page-item"><a href="/TTMS/view/headteacher/EditTermMater.php?page= <?php echo $next ?>" class="page-link">Next</a></li>
                </ul>
            </div>
        </div>
      </div>    
...
$(document).ready(
        ...
        $('#btn_cancel').click(function(){
            ...
            window.location.href = "/TTMS/view/headteacher/PositionMaster.php";
        });
