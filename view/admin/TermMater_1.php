...
$(document).ready(function(){
    ...
    $(".add-new").click(function(){
        ...
        var row = '<tr>' +
            '<td><input type="text" class="form-control" name="name" id="name"> <input type="text"/></td>' +
            '<td><input type="text" class="form-control" name="department" id="department"> <input type="text"/></td>' +
            '<td><input type="text" class="form-control" name="phone" id="phone"> <input type="text"/></td>' +
			'<td>' + actions + '</td>' +
        '</tr>';
    	$("table").append(row);		
	...
	$(document).on("click", ".add", function(){
		...
		if(!empty){
			input.each(function(){
				$(this).parent("td").html($(this).val()+"<input type='text' name='name_array[]' value = '"+$(this).val()+"'/>");
...
<!--            <div class="table-title">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo $nn = $row['Name']; ?>  <input name="name_array[]" readonly="" type="text" class="form-control" value="<?php echo $nn; ?>"/></td>
                    ...
                    <input type="hidden" name="btn_term" value="btn_term"/>
