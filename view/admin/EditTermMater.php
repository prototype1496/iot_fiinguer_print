...
$(document).ready(function(){
	...
	$(document).on("click", ".add", function(){
		...
		if(!empty){
			input.each(function(){
				$(this).parent("td").html($(this).val()+"<input type='hidden' name='term_arry[]' value='"+$(this).val()+"'/><input type='hidden' name='isedited_arry[]' value='1'/>");
			});			
...
<form id="terms" method="post" action="../../controller/head_teacher/ActionPerformed.php">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                <input name="term_id[]" value="<?php echo $row['TermMasterID']; ?>" type="hidden"/>
                <td><?php echo $row['TermName']; ?> <input type="hidden" name="term_arry[]" value="<?php echo $row['TermName']; ?>"/><input type='hidden' name='isedited_arry[]' value='0'/></td>
    ...
    <input type="hidden" value="term_arry" name="btn_term_edit"/>
...
$(document).ready(
        ...
        $('#btn_cancel').click(function(){
            ...
            window.location.href = "/TTMS/view/headteacher/TermMater.php";
        });
